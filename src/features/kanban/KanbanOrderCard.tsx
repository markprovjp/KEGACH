...
export function KanbanOrderCard({ order, onEdit, onDelete, compact }: { order: KanbanOrder; onEdit: (order: KanbanOrder) => void; onDelete: (order: KanbanOrder) => void; compact?: boolean }) {
