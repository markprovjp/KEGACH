...
export const sampleProducts: CatalogProduct[] = [
  { id: "ke-can-bang-1mm", name: "Ke cân bằng 1MM", unit: "kg", defaultPrice: 47000, distributorPrice: 44000, packageRule: "30 kg / bao", weightPerUnitKg: 1, aliases: [{ value: "kcb" }, { value: "1ly" }, { value: "ke 1 ly" }], description: "Ke cân bằng sản xuất từ nhựa PP nguyên sinh, dai, chịu lực kéo tốt khi siết kìm." },
  { id: "ke-can-bang-1-5mm", name: "Ke cân bằng 1.5MM", unit: "kg", defaultPrice: 47000, distributorPrice: 44000, packageRule: "30 kg / bao", weightPerUnitKg: 1, aliases: [{ value: "1.5ly" }, { value: "ke 1.5 ly" }] },
  { id: "ke-can-bang-2mm", name: "Ke cân bằng 2MM", unit: "kg", defaultPrice: 47000, distributorPrice: 44000, packageRule: "30 kg / bao", weightPerUnitKg: 1, aliases: [{ value: "B04" }, { value: "2ly" }, { value: "ke 2 ly" }] },
  { id: "ke-can-bang-3mm", name: "Ke cân bằng 3MM", unit: "kg", defaultPrice: 47000, distributorPrice: 44000, packageRule: "30 kg / bao", weightPerUnitKg: 1, aliases: [{ value: "B03" }, { value: "3ly" }, { value: "ke 3 ly" }] },
  { id: "nem", name: "Nêm", unit: "kg", defaultPrice: 35000, distributorPrice: 28000, packageRule: "30 kg / bao", weightPerUnitKg: 1, aliases: [{ value: "nem" }, { value: "nêm" }, { value: "nem 1 bao" }], description: "Nêm nhựa cứng chịu lực cao, răng cưa sâu, ăn khớp với ke và có thể tái sử dụng." },
  ...
  { id: "kim-siet-ke", name: "Kìm siết ke", unit: "thùng", defaultPrice: 25000, distributorPrice: 17000, packageRule: "50 cái / thùng", aliases: [{ value: "kìm siết" }, { value: "kim siet" }] },
  { id: "ke-chu-thap-1mm", name: "Ke chữ thập 1MM", unit: "kg", defaultPrice: 80000, distributorPrice: 75000, packageRule: "30 kg / bao", weightPerUnitKg: 1, aliases: [{ value: "chữ thập 1ly" }] },
  { id: "ke-chu-thap-1-5mm", name: "Ke chữ thập 1.5MM", unit: "kg", defaultPrice: 80000, distributorPrice: 75000, packageRule: "30 kg / bao", weightPerUnitKg: 1, aliases: [{ value: "chữ thập 1.5ly" }] },
  { id: "ke-chu-thap-2mm", name: "Ke chữ thập 2MM", unit: "kg", defaultPrice: 80000, distributorPrice: 75000, packageRule: "30 kg / bao", weightPerUnitKg: 1, aliases: [{ value: "chữ thập 2ly" }] },
  { id: "ke-chu-thap-3mm", name: "Ke chữ thập 3MM", unit: "kg", defaultPrice: 80000, distributorPrice: 75000, packageRule: "30 kg / bao", weightPerUnitKg: 1, aliases: [{ value: "chữ thập 3ly" }] },
  { id: "ke-chu-thap-5mm", name: "Ke chữ thập 5MM", unit: "kg", defaultPrice: 80000, distributorPrice: 75000, packageRule: "30 kg / bao", weightPerUnitKg: 1, aliases: [{ value: "5ly" }, { value: "chữ thập 5ly" }] },
  { id: "ke-vit-xoay-1mm", name: "Ke vít xoáy 1MM", unit: "thùng", defaultPrice: 35000, distributorPrice: 26000, packageRule: "60 túi / thùng - 1 túi 50 cái", aliases: [{ value: "vít xoáy 1ly" }, { value: "vit xoay 1ly" }] },
  { id: "ke-vit-xoay-1-5mm", name: "Ke vít xoáy 1.5MM", unit: "thùng", defaultPrice: 35000, distributorPrice: 26000, packageRule: "60 túi / thùng - 1 túi 50 cái", aliases: [{ value: "vít xoáy 1.5ly" }, { value: "vit xoay 1.5ly" }] },
  { id: "nuoc-tay-xi-mang", name: "Nước tẩy xi măng", unit: "can", defaultPrice: 40000, distributorPrice: 30000, packageRule: "12 can / 1 thùng 1.7 lít", aliases: [{ value: "nước tẩy" }, { value: "tay xi mang" }] },
  { id: "keo-bonbond", name: "Keo 2 thành phần BONBOND", unit: "tuýp", defaultPrice: 60000, packageRule: "30 cái / thùng", aliases: [{ value: "bonbond" }, { value: "b01" }, { value: "b14" }], description: "Hàng công nghệ Thái. Dòng keo chống bám bẩn, nấm mốc, chống thấm, chống xước ron, nhiều màu." },
  { id: "keo-epoxy-cat", name: "Keo 2 thành phần EPOXY CAT", unit: "tuýp", defaultPrice: 70000, distributorPrice: 45000, packageRule: "30 cái / thùng", aliases: [{ value: "epoxy cat" }, { value: "cat01" }, { value: "cat14" }], description: "Dung tích keo lớn, chống bám bẩn, nấm mốc, chống thấm, chống xước ron, nhiều màu." },
  { id: "sung-ban-keo-epoxy", name: "Súng bắn keo EPOXY", unit: "cái", defaultPrice: 70000, distributorPrice: 55000, packageRule: "30 cái / thùng", aliases: [{ value: "súng epoxy" }, { value: "sung epoxy" }] },
  { id: "bo-biron-re", name: "Bộ biron rẻ", unit: "bộ", defaultPrice: 20000, distributorPrice: 15000, packageRule: undefined, aliases: [{ value: "biron rẻ" }] },
  { id: "bo-biron-dat", name: "Bộ biron đắt", unit: "bộ", defaultPrice: 35000, distributorPrice: 30000, packageRule: undefined, aliases: [{ value: "biron đắt" }] },
  { id: "rach-mach", name: "Rạch mạch", unit: "cái", defaultPrice: 10000, distributorPrice: 8000, packageRule: undefined, aliases: [{ value: "rạch mạch" }] },
  { id: "sui", name: "Sủi", unit: "cái", defaultPrice: 20000, distributorPrice: 15000, packageRule: undefined, aliases: [{ value: "sủi" }, { value: "sui" }] },
  { id: "kich-gach", name: "Kích gạch", unit: "cái", defaultPrice: 30000, distributorPrice: 27000, packageRule: "40 cái / thùng", aliases: [{ value: "kích gạch" }] },
  { id: "ban-keo-rang-cua", name: "Bàn kéo răng cưa", unit: "cái", defaultPrice: 90000, distributorPrice: 90000, packageRule: undefined, aliases: [{ value: "bàn kéo" }] },
  { id: "bay-rang-cua", name: "Bay răng cưa", unit: "cái", defaultPrice: 45000, distributorPrice: 45000, packageRule: undefined, aliases: [{ value: "bay" }] },
  { id: "mu-chiet-mach", name: "Mủ chiết mạch", unit: "cái", defaultPrice: 12000, distributorPrice: 12000, packageRule: undefined, weightPerUnitKg: 1, aliases: [{ value: "mủ chiết mạch" }] },
  { id: "sung-dien-full-bo", name: "Súng điện full bộ", unit: "bộ", defaultPrice: 1300000, distributorPrice: 1300000, packageRule: "1 bộ", weightPerUnitKg: 5, aliases: [{ value: "súng điện" }, { value: "sung dien" }, { value: "súng điện full bộ" }] },
...
export const productVariantSeeds: ProductVariantSeed[] = [
  ...
  { productId: "keo-bonbond", code: "13", cartonCount: 16, tubeCount: 9 },
  { productId: "keo-bonbond", code: "14", cartonCount: 50, tubeCount: 29 },
  ...
  { productId: "keo-epoxy-cat", code: "14", cartonCount: 0, tubeCount: 0 }
];
